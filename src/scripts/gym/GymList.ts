...
GymList['Pewter City'] = new Gym(
    ...
    'Pewter City',
    [
        new GymPokemon('Geodude', 993, 12),
        new GymPokemon('Onix', 4399, 14),
    ],
    BadgeEnums.Boulder,
    250*2,
...
GymList['Cerulean City'] = new Gym(
    ...
    'Cerulean City',
    [
        new GymPokemon('Staryu', 7000, 18),
        new GymPokemon('Starmie', 10800, 21),
    ],
    BadgeEnums.Cascade,
    500*2,
...
GymList['Vermilion City'] = new Gym(
    ...
    'Vermilion City',
    [
        new GymPokemon('Voltorb', 60780, 21),
        new GymPokemon('Pikachu', 63540, 18),
        new GymPokemon('Raichu', 65675, 24),
    ],
    BadgeEnums.Thunder,
    1000*2,
...
GymList['Celadon City'] = new Gym(
    ...
    'Celadon City',
    [
        new GymPokemon('Victreebel', 88810, 29),
        new GymPokemon('Tangela', 80340, 24),
        new GymPokemon('Vileplume', 106400, 29),
    ],
    BadgeEnums.Rainbow,
    1500*2,
...
GymList['Saffron City'] = new Gym(
    ...
    'Saffron City',
    [
        new GymPokemon('Kadabra', 253040, 38),
        new GymPokemon('Mr. Mime', 255600, 37),
        new GymPokemon('Venomoth', 258400, 38),
        new GymPokemon('Alakazam', 455380, 43),
    ],
    BadgeEnums.Marsh,
    2500*2,
...
GymList['Fuchsia City'] = new Gym(
    ...
    'Fuchsia City',
    [
        new GymPokemon('Koffing', 320780, 37),
        new GymPokemon('Muk', 320460, 39),
        new GymPokemon('Koffing', 380430, 37),
        new GymPokemon('Weezing', 540430, 43),
    ],
    BadgeEnums.Soul,
    3500*2,
...
GymList['Cinnabar Island'] = new Gym(
    ...
    'Cinnabar Island',
    [
        new GymPokemon('Growlithe', 370430, 42),
        new GymPokemon('Ponyta', 420340, 40),
        new GymPokemon('Rapidash', 450230, 42),
        new GymPokemon('Arcanine', 700290, 47),
    ],
    BadgeEnums.Volcano,
    5000*2,
...
GymList['Viridian City'] = new Gym(
    ...
    'Viridian City',
    [
        new GymPokemon('Rhyhorn', 550230, 45),
        new GymPokemon('Dugtrio', 570530, 42),
        new GymPokemon('Nidoqueen', 580740, 44),
        new GymPokemon('Nidoking', 580350, 45),
        new GymPokemon('Rhyhorn', 650000, 50),
    ],
    BadgeEnums.Earth,
    6000*2,
...
GymList['Elite Lorelei'] = new Gym(
    ...
    'Elite Lorelei',
    [
        new GymPokemon('Dewgong', 950330, 52),
        new GymPokemon('Cloyster', 980300, 51),
        new GymPokemon('Slowbro', 1020000, 52),
        new GymPokemon('Jynx', 1070000, 54),
        new GymPokemon('Lapras', 1102050, 54),
    ],
...
GymList['Elite Bruno'] = new Gym(
    ...
    'Elite Bruno',
    [
        new GymPokemon('Onix', 950330, 51),
        new GymPokemon('Hitmonchan', 980300, 53),
        new GymPokemon('Hitmonlee', 1020000, 53),
        new GymPokemon('Onix', 1070000, 54),
        new GymPokemon('Machamp', 1102050, 56),
    ],
...
GymList['Elite Agatha'] = new Gym(
    ...
    'Elite Agatha',
    [
        new GymPokemon('Gengar', 950330, 54),
        new GymPokemon('Golbat', 980300, 54),
        new GymPokemon('Haunter', 1020000, 53),
        new GymPokemon('Arbok', 1070000, 56),
        new GymPokemon('Gengar', 1102050, 58),
    ],
...
GymList['Elite Lance'] = new Gym(
    ...
    'Elite Lance',
    [
        new GymPokemon('Gyarados', 1150330, 56),
        new GymPokemon('Dragonair', 1180300, 54),
        new GymPokemon('Dragonair', 1180300, 54),
        new GymPokemon('Aerodactyl', 1270000, 58),
        new GymPokemon('Dragonite', 1302050, 60),
    ],
...
GymList['Champion Blue'] = new Gym(
    ...
    'Champion Blue',
    [
        new GymPokemon('Pidgeot', 1220340, 59),
        new GymPokemon('Alakazam', 1260320, 57),
        new GymPokemon('Rhydon', 1280340, 59),
        new GymPokemon('Exeggutor', 1270520, 59, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Grass)),
        new GymPokemon('Gyarados', 1350340, 61, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Grass)),
        new GymPokemon('Charizard', 1500000, 63, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Grass)),
        new GymPokemon('Arcanine', 1270520, 59, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Fire)),
        new GymPokemon('Exeggutor', 1350340, 61, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Fire)),
        new GymPokemon('Blastoise', 1500000, 63, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Fire)),
        new GymPokemon('Gyarados', 1270520, 59, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Water)),
        new GymPokemon('Arcanine', 1350340, 61, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Water)),
        new GymPokemon('Venusaur', 1500000, 63, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Water)),
        new GymPokemon('Gyarados', 1270520, 59, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Special)),
        new GymPokemon('Arcanine', 1350340, 61, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Special)),
        new GymPokemon('Venusaur', 1500000, 63, new StarterRequirement(GameConstants.Region.kanto, GameConstants.Starter.Special)),
    ],
...
GymList['Violet City'] = new Gym(
    ...
    'Violet City',
    [
        new GymPokemon('Pidgey', 4860000, 7),
        new GymPokemon('Pidgeotto', 5040000, 9),
    ],
    BadgeEnums.Zephyr,
    500,
...
GymList['Azalea Town'] = new Gym(
    ...
    'Azalea Town',
    [
        new GymPokemon('Metapod', 4635000, 14),
        new GymPokemon('Kakuna', 4567500, 14),
        new GymPokemon('Scyther', 5355000, 16),
    ],
    BadgeEnums.Hive,
    1000,
...
GymList['Goldenrod City'] = new Gym(
    ...
    'Goldenrod City',
    [
        new GymPokemon('Clefairy', 6500000, 18),
        new GymPokemon('Miltank', 8500000, 20),
    ],
    BadgeEnums.Plain,
    1500,
...
GymList['Ecruteak City'] = new Gym(
    ...
    'Ecruteak City',
    [
        new GymPokemon('Gastly', 6350000, 21),
        new GymPokemon('Haunter', 6400000, 21),
        new GymPokemon('Gengar', 6600000, 25),
        new GymPokemon('Haunter', 6500000, 23),
    ],
    BadgeEnums.Fog,
    2500,
...
GymList['Cianwood City'] = new Gym(
    ...
    'Cianwood City',
    [
        new GymPokemon('Primeape', 13275000, 27),
        new GymPokemon('Poliwrath', 13275000, 30),
    ],
    BadgeEnums.Storm,
    3500,
...
GymList['Olivine City'] = new Gym(
    ...
    'Olivine City',
    [
        new GymPokemon('Magnemite', 13275000, 30),
        new GymPokemon('Magnemite', 13350000, 30),
        new GymPokemon('Steelix', 13650000, 35),
    ],
    BadgeEnums.Mineral,
    4000,
...
GymList['Mahogany Town'] = new Gym(
    ...
    'Mahogany Town',
    [
        new GymPokemon('Seel', 14250000, 27),
        new GymPokemon('Dewgong', 14437500, 29),
        new GymPokemon('Piloswine', 14700000, 31),
    ],
    BadgeEnums.Glacier,
    5000,
...
GymList['Blackthorn City'] = new Gym(
    ...
    'Blackthorn City',
    [
        new GymPokemon('Dragonair', 18450000, 37),
        new GymPokemon('Dragonair', 18450000, 37),
        new GymPokemon('Dragonair', 19620000, 37),
        new GymPokemon('Kingdra', 19800000, 40),
    ],
    BadgeEnums.Rising,
    7500,
...
GymList['Elite Will'] = new Gym(
    ...
    'Elite Will',
    [
        new GymPokemon('Xatu', 23306350, 40),
        new GymPokemon('Exeggutor', 23588500, 41),
        new GymPokemon('Slowbro', 23940000, 41),
        new GymPokemon('Jynx', 24415000, 41),
        new GymPokemon('Xatu', 24723750, 42),
    ],
...
GymList['Elite Koga'] = new Gym(
    ...
    'Elite Koga',
    [
        new GymPokemon('Ariados', 23306350, 40),
        new GymPokemon('Venomoth', 23588500, 41),
        new GymPokemon('Forretress', 23940000, 43),
        new GymPokemon('Muk', 24415000, 42),
        new GymPokemon('Crobat', 24723750, 44),
    ],
...
GymList['Elite Bruno2'] = new Gym(
    ...
    'Elite Bruno2',
    [
        new GymPokemon('Hitmontop', 23306350, 42),
        new GymPokemon('Hitmonlee', 23588500, 42),
        new GymPokemon('Hitmonchan', 23940000, 42),
        new GymPokemon('Onix', 24415000, 43),
        new GymPokemon('Machamp', 24723750, 46),
    ],
...
GymList['Elite Karen'] = new Gym(
    ...
    'Elite Karen',
    [
        new GymPokemon('Umbreon', 23588500, 42),
        new GymPokemon('Vileplume', 23940000, 42),
        new GymPokemon('Murkrow', 24415000, 44),
        new GymPokemon('Gengar', 24723750, 45),
        new GymPokemon('Houndoom', 25270000, 47),
    ],
...
GymList['Champion Lance'] = new Gym(
    ...
    'Champion Lance',
    [
        new GymPokemon('Gyarados', 25830000, 44),
        new GymPokemon('Dragonite', 26200000, 47),
        new GymPokemon('Charizard', 26400000, 46),
        new GymPokemon('Aerodactyl', 26025000, 46),
        new GymPokemon('Dragonite', 27000000, 47),
...
GymList['Rustboro City'] = new Gym(
    ...
    'Rustboro City',
    [
        new GymPokemon('Geodude', 32546500, 12),
        new GymPokemon('Geodude', 32546500, 12),
        new GymPokemon('Nosepass', 34867000, 15),
    ],
    BadgeEnums.Stone,
    1000,
...
GymList['Dewford Town'] = new Gym(
    ...
    'Dewford Town',
    [
        new GymPokemon('Machop', 38160000, 16),
        new GymPokemon('Meditite', 38160000, 16),
        new GymPokemon('Makuhita', 39960000, 19),
    ],
    BadgeEnums.Knuckle,
    2000,
...
GymList['Mauville City'] = new Gym(
    ...
    'Mauville City',
    [
        new GymPokemon('Voltorb', 51980000, 20),
        new GymPokemon('Electrike', 51520000, 20),
        new GymPokemon('Magneton', 55545000, 22),
        new GymPokemon('Manectric', 51520000, 24),
    ],
    BadgeEnums.Dynamo,
    3000,
...
GymList['Lavaridge Town'] = new Gym(
    ...
    'Lavaridge Town',
    [
        new GymPokemon('Numel', 54280000, 24),
        new GymPokemon('Slugma', 54280000, 24),
        new GymPokemon('Camerupt', 56580000, 26),
        new GymPokemon('Torkoal', 60260000, 29),
    ],
    BadgeEnums.Heat,
    4000,
...
GymList['Petalburg City'] = new Gym(
    ...
    'Petalburg City',
    [
        new GymPokemon('Spinda', 490000*130, 27),
        new GymPokemon('Vigoroth', 530000*130, 27),
        new GymPokemon('Linoone', 560000*130, 29),
        new GymPokemon('Slaking', 596000*130, 31),
    ],
    BadgeEnums.Balance,
    5000,
...
GymList['Fortree City'] = new Gym(
    ...
    'Fortree City',
    [
        new GymPokemon('Swablu', 605000*130, 29),
        new GymPokemon('Tropius', 650000*130, 29),
        new GymPokemon('Pelipper', 630000*130, 30),
        new GymPokemon('Skarmory', 667000*130, 31),
        new GymPokemon('Altaria', 669000*130, 33),
    ],
    BadgeEnums.Feather,
    6000,
...
GymList['Mossdeep City'] = new Gym(
    ...
    'Mossdeep City',
    [
        new GymPokemon('Claydol', 702000*150, 41),
        new GymPokemon('Xatu', 703000*150, 41),
        new GymPokemon('Lunatone', 702000*150, 42),
        new GymPokemon('Solrock', 703000*150, 42),
    ],
    BadgeEnums.Mind,
    8000,
...
GymList['Sootopolis City'] = new Gym(
    ...
    'Sootopolis City',
    [
        new GymPokemon('Luvdisc', 798000*150, 41),
        new GymPokemon('Whiscash', 813000*150, 41),
        new GymPokemon('Sealeo', 823400*150, 43),
        new GymPokemon('Crawdaunt', 842000*150, 43),
        new GymPokemon('Kingdra', 865000*150, 46),
    ],
    BadgeEnums.Rain,
    10000,
...
GymList['Elite Sidney'] = new Gym(
    ...
    'Elite Sidney',
    [
        new GymPokemon('Mightyena', 972000*185, 46),
        new GymPokemon('Shiftry', 980000*185, 48),
        new GymPokemon('Cacturne', 1002000*185, 46),
        new GymPokemon('Crawdaunt', 1015000*185, 48),
        new GymPokemon('Absol', 1020000*185, 49),
    ],
...
GymList['Elite Phoebe'] = new Gym(
    ...
    'Elite Phoebe',
    [
        new GymPokemon('Dusclops', 1036700*185, 48),
        new GymPokemon('Banette', 1038000*185, 49),
        new GymPokemon('Sableye', 1052000*185, 50),
        new GymPokemon('Banette', 1038000*185, 49),
        new GymPokemon('Dusclops', 1063000*185, 51),
    ],
...
GymList['Elite Glacia'] = new Gym(
    ...
    'Elite Glacia',
    [
        new GymPokemon('Sealeo', 1082000*185, 50),
        new GymPokemon('Glalie', 1072000*185, 50),
        new GymPokemon('Sealeo', 1086000*185, 52),
        new GymPokemon('Glalie', 1076000*185, 52),
        new GymPokemon('Walrein', 1100000*185, 53),
    ],
...
GymList['Elite Drake'] = new Gym(
    ...
    'Elite Drake',
    [
        new GymPokemon('Shelgon', 1064000*185, 52),
        new GymPokemon('Altaria', 1072000*185, 54),
        new GymPokemon('Kingdra', 1076000*185, 53),
        new GymPokemon('Flygon', 1076000*185, 53),
        new GymPokemon('Salamence', 1157000*185, 55),
    ],
...
GymList['Champion Wallace'] = new Gym(
    ...
    'Champion Wallace',
    [
        new GymPokemon('Wailord', 1202000*200, 57),
        new GymPokemon('Tentacruel', 1164000*200, 55),
        new GymPokemon('Ludicolo', 1184000*200, 56),
        new GymPokemon('Whiscash', 1172000*200, 56),
        new GymPokemon('Gyarados', 1163000*200, 56),
        new GymPokemon('Milotic', 1182000*200, 58),
    ],
...
GymList['Mikan Island'] = new Gym(
    ...
    'Mikan Island',
    [
        new GymPokemon('Seadra', 2307500*185, 24),
        new GymPokemon('Blastoise', 2307500*185, 24),
    ],
...
GymList['Navel Island'] = new Gym(
    ...
    'Navel Island',
    [
        new GymPokemon('Geodude', 923000*185, 24),
        new GymPokemon('Nidoqueen', 923000*185, 24),
        new GymPokemon('Machoke', 923000*185, 24),
        new GymPokemon('Scyther', 923000*185, 24),
        new GymPokemon('Electrode', 923000*185, 24),
    ],
    BadgeEnums.Sea_Ruby,
    10000,
...
GymList['Trovita Island'] = new Gym(
    ...
    'Trovita Island',
    [
        new GymPokemon('Electabuzz', 1538333*185, 24),
        new GymPokemon('Exeggutor', 1538333*185, 24),
        new GymPokemon('Starmie', 1538333*185, 24),
    ],
...
GymList['Kumquat Island'] = new Gym(
    ...
    'Kumquat Island',
    [
        new GymPokemon('Alakazam', 2307500*185, 24),
        new GymPokemon('Marowak', 2307500*185, 24),
    ],
...
GymList['Supreme Gym Leader Drake'] = new Gym(
    ...
    'Supreme Gym Leader Drake',
    [
        new GymPokemon('Ditto', 899520*185, 38),
        new GymPokemon('Onix', 899520*185, 39),
        new GymPokemon('Gengar', 899520*185, 40),
        new GymPokemon('Venusaur', 899520*185, 40),
        new GymPokemon('Electabuzz', 899520*185, 41),
        new GymPokemon('Dragonite', 1124400*185, 37),
    ],
...
GymList['Cipher Admin Ein'] = new Gym (
    ...
    'Cipher Admin Ein',
    [
        new GymPokemon('Crobat', 12099520*185, 48),
        new GymPokemon('Pelipper', 12099520*185, 49),
        new GymPokemon('Rhydon', 12099520*185, 50),
        new GymPokemon('Starmie', 12099520*185, 49),
        new GymPokemon('Manectric', 12099520*185, 50),
    ],
...
GymList['Cipher Admin Miror B.'] = new Gym (
    ...
    'Cipher Admin Miror B.',
    [
        new GymPokemon('Ludicolo', 11599520*185, 44),
        new GymPokemon('Ludicolo', 11599520*185, 45),
        new GymPokemon('Loudred', 11599520*185, 46),
        new GymPokemon('Golduck', 11599520*185, 45),
        new GymPokemon('Armaldo', 11599520*185, 43),
    ],
...
GymList['Cipher Admin Dakim'] = new Gym (
    ...
    'Cipher Admin Dakim',
    [
        new GymPokemon('Claydol', 11999520*185, 46),
        new GymPokemon('Forretress', 11999520*185, 45),
        new GymPokemon('Flygon', 11999520*185, 46),
        new GymPokemon('Whiscash', 11999520*185, 46),
        new GymPokemon('Houndoom', 11999520*185, 47),
    ],
...
GymList['Cipher Admin Venus'] = new Gym (
    ...
    'Cipher Admin Venus',
    [
        new GymPokemon('Bellossom', 12299520*185, 47),
        new GymPokemon('Misdreavus', 12299520*185, 47),
        new GymPokemon('Raichu', 12299520*185, 48),
        new GymPokemon('Wigglytuff', 12299520*185, 48),
        new GymPokemon('Milotic', 12299520*185, 48),
    ],
...
GymList['Cipher Admin Lovrina'] = new Gym ( //Kalos E4 difficulty, plus 10% per Orre Colosseum boss
    ...
    'Cipher Admin Lovrina',
    [
        new GymPokemon('Shuckle', 30994948*1900, 100),
        new GymPokemon('Milotic', 30994948*1900, 100),
        new GymPokemon('Wobbuffet', 30994948*1900, 100),
        new GymPokemon('Blissey', 30994948*1900, 100),
        new GymPokemon('Misdreavus', 30994948*1900, 100),
        new GymPokemon('Meganium', 30994948*1900, 100),
    ],
...
GymList['Cipher Admin Snattle'] = new Gym (
    ...
    'Cipher Admin Snattle',
    [
        new GymPokemon('Electrode', 34094443*1900, 100),
        new GymPokemon('Gengar', 34094443*1900, 100),
        new GymPokemon('Muk', 34094443*1900, 100),
        new GymPokemon('Glalie', 34094443*1900, 100),
        new GymPokemon('Regirock', 34094443*1900, 100),
        new GymPokemon('Regice', 34094443*1900, 100),
    ],
...
GymList['Cipher Admin Gorigan'] = new Gym (
    ...
    'Cipher Admin Gorigan',
    [
        new GymPokemon('Salamence', 37503887*1900, 100),
        new GymPokemon('Granbull', 37503887*1900, 100),
        new GymPokemon('Arcanine', 37503887*1900, 100),
        new GymPokemon('Tauros', 37503887*1900, 100),
        new GymPokemon('Hitmontop', 37503887*1900, 100),
        new GymPokemon('Gyarados', 37503887*1900, 100),
    ],
...
GymList['Cipher Admin Ardos'] = new Gym (
    ...
    'Cipher Admin Ardos',
    [
        new GymPokemon('Sceptile', 41254276*1900, 100),
        new GymPokemon('Charizard', 41254276*1900, 100),
        new GymPokemon('Gengar', 41254276*1900, 100),
        new GymPokemon('Aerodactyl', 41254276*1900, 100),
        new GymPokemon('Tauros', 41254276*1900, 100),
        new GymPokemon('Starmie', 41254276*1900, 100),
    ],
...
GymList['Cipher Admin Eldes'] = new Gym (
    ...
    'Cipher Admin Eldes',
    [
        new GymPokemon('Latios', 45379704*1900, 100),
        new GymPokemon('Latias', 45379704*1900, 100),
        new GymPokemon('Gengar', 45379704*1900, 100),
        new GymPokemon('Metagross', 45379704*1900, 100),
        new GymPokemon('Snorlax', 45379704*1900, 100),
        new GymPokemon('Tauros', 45379704*1900, 100),
    ],
...
GymList['Oreburgh City'] = new Gym(
    ...
    'Oreburgh City',
    [
        new GymPokemon('Geodude', 1338000*180, 12),
        new GymPokemon('Onix', 1342000*180, 12),
        new GymPokemon('Cranidos', 1342000*180, 14),
    ],
    BadgeEnums.Coal,
    250,
...
GymList['Eterna City'] = new Gym(
    ...
    'Eterna City',
    [
        new GymPokemon('Turtwig', 1433000*195, 20),
        new GymPokemon('Cherrim (Overcast)', 1437500*195, 20),
        new GymPokemon('Roserade', 1439000*195, 22),
    ],
    BadgeEnums.Forest,
    400,
...
GymList['Hearthome City'] = new Gym(
    ...
    'Hearthome City',
    [
        new GymPokemon('Duskull', 1450000*215, 24),
        new GymPokemon('Haunter', 1480000*215, 24),
        new GymPokemon('Mismagius', 1480000*215, 26),
    ],
    BadgeEnums.Relic,
    740,
...
GymList['Veilstone City'] = new Gym(
    ...
    'Veilstone City',
    [
        new GymPokemon('Meditite', 1537000*245, 28),
        new GymPokemon('Machoke', 1538000*245, 29),
        new GymPokemon('Lucario', 1540000*245, 32),
    ],
    BadgeEnums.Cobble,
    1200,
...
GymList['Pastoria City'] = new Gym(
    ...
    'Pastoria City',
    [
        new GymPokemon('Gyarados', 1687000*275, 33),
        new GymPokemon('Quagsire', 1693000*275, 34),
        new GymPokemon('Floatzel', 1693000*275, 37),
    ],
    BadgeEnums.Fen,
    2500,
...
GymList['Canalave City'] = new Gym(
    ...
    'Canalave City',
    [
        new GymPokemon('Magneton', 1767000*375, 37),
        new GymPokemon('Steelix', 1772000*375, 38),
        new GymPokemon('Bastiodon', 1768000*375, 41),
    ],
    BadgeEnums.Mine,
    4800,
...
GymList['Snowpoint City'] = new Gym(
    ...
    'Snowpoint City',
    [
        new GymPokemon('Sneasel', 1872500*425, 40),
        new GymPokemon('Piloswine', 1876000*425, 40),
        new GymPokemon('Abomasnow', 1870000*425, 42),
        new GymPokemon('Froslass', 1870000*425, 44),
    ],
    BadgeEnums.Icicle,
    8000,
...
GymList['Sunyshore City'] = new Gym(
    ...
    'Sunyshore City',
    [
        new GymPokemon('Jolteon', 1965000*500, 46),
        new GymPokemon('Raichu', 1965000*500, 46),
        new GymPokemon('Luxray', 1978000*500, 48),
        new GymPokemon('Electivire', 1980000*500, 50),
    ],
    BadgeEnums.Beacon,
    12000,
...
GymList['Elite Aaron'] = new Gym(
    ...
    'Elite Aaron',
    [
        new GymPokemon('Yanmega', 2545330*600, 49),
        new GymPokemon('Scizor', 2548300*600, 49),
        new GymPokemon('Vespiquen', 2552000*600, 50),
        new GymPokemon('Heracross', 2557000*600, 51),
        new GymPokemon('Drapion', 2560250*600, 53),
    ],
...
GymList['Elite Bertha'] = new Gym(
    ...
    'Elite Bertha',
    [
        new GymPokemon('Whiscash', 2645330*600, 50),
        new GymPokemon('Gliscor', 2648300*600, 53),
        new GymPokemon('Hippowdon', 2652000*600, 52),
        new GymPokemon('Golem', 2657000*600, 52),
        new GymPokemon('Rhyperior', 2660250*600, 55),
    ],
...
GymList['Elite Flint'] = new Gym(
    ...
    'Elite Flint',
    [
        new GymPokemon('Houndoom', 2845330*600, 52),
        new GymPokemon('Flareon', 2848300*600, 55),
        new GymPokemon('Rapidash', 2852000*600, 53),
        new GymPokemon('Infernape', 2857000*600, 55),
        new GymPokemon('Magmortar', 2860250*600, 57),
    ],
...
GymList['Elite Lucian'] = new Gym(
    ...
    'Elite Lucian',
    [
        new GymPokemon('Mr. Mime', 3048300*600, 53),
        new GymPokemon('Espeon', 3052000*600, 55),
        new GymPokemon('Bronzong', 3057000*600, 54),
        new GymPokemon('Alakazam', 3060250*600, 56),
        new GymPokemon('Gallade', 3066000*600, 59),
    ],
...
GymList['Champion Cynthia'] = new Gym(
    ...
    'Champion Cynthia',
    [
        new GymPokemon('Spiritomb', 3458300*750, 58),
        new GymPokemon('Roserade', 3462000*750, 58),
        new GymPokemon('Togekiss', 3464000*750, 60),
        new GymPokemon('Lucario', 3460250*750, 60),
        new GymPokemon('Milotic', 3470000*750, 58),
        new GymPokemon('Garchomp', 3570000*750, 62),
    ],
...
GymList['Aspertia City'] = new Gym(
    ...
    'Aspertia City',
    [
        new GymPokemon('Patrat', 3458300*675, 12),
        new GymPokemon('Pidove', 3462000*675, 12),
        new GymPokemon('Lillipup', 3464000*675, 14),
    ],
    BadgeEnums.Basic,
    500,
...
GymList['Virbank City'] = new Gym(
    ...
    'Virbank City',
    [
        new GymPokemon('Koffing', 3658300*675, 17),
        new GymPokemon('Grimer', 3662000*675, 17),
        new GymPokemon('Whirlipede', 3664000*675, 19),
    ],
    BadgeEnums.Toxic,
    800,
...
GymList['Castelia City'] = new Gym(
    ...
    'Castelia City',
    [
        new GymPokemon('Dwebble', 3858300*775, 24),
        new GymPokemon('Shelmet', 3862000*775, 24),
        new GymPokemon('Karrablast', 3964000*775, 24),
        new GymPokemon('Leavanny', 4064000*775, 26),
    ],
    BadgeEnums.Insect,
    1500,
...
GymList['Nimbasa City'] = new Gym(
    ...
    'Nimbasa City',
    [
        new GymPokemon('Emolga', 4258300*775, 30),
        new GymPokemon('Flaaffy', 4262000*775, 30),
        new GymPokemon('Joltik', 4464000*775, 30),
        new GymPokemon('Zebstrika', 4464000*775, 32),
    ],
    BadgeEnums.Bolt,
    2600,
...
GymList['Driftveil City'] = new Gym(
    ...
    'Driftveil City',
    [
        new GymPokemon('Krokorok', 4658300*825, 34),
        new GymPokemon('Sandslash', 4662000*825, 34),
        new GymPokemon('Onix', 4864000*825, 34),
        new GymPokemon('Excadrill', 5064000*825, 36),
    ],
    BadgeEnums.Quake,
    4800,
...
GymList['Mistralton City'] = new Gym(
    ...
    'Mistralton City',
    [
        new GymPokemon('Swoobat', 5458300*875, 40),
        new GymPokemon('Skarmory', 6062000*875, 40),
        new GymPokemon('Sigilyph', 5664000*875, 40),
        new GymPokemon('Swanna', 5864000*875, 42),
    ],
    BadgeEnums.Jet,
    7600,
...
GymList['Opelucid City'] = new Gym(
    ...
    'Opelucid City',
    [
        new GymPokemon('Druddigon', 6558300*1000, 50),
        new GymPokemon('Flygon', 6662000*1000, 50),
        new GymPokemon('Altaria', 6464000*1000, 50),
        new GymPokemon('Haxorus', 6964000*1000, 52),
    ],
    BadgeEnums.Legend,
    14000,
...
GymList['Humilau City'] = new Gym(
    ...
    'Humilau City',
    [
        new GymPokemon('Wailord', 7458300*1150, 53),
        new GymPokemon('Mantine', 7262000*1150, 53),
        new GymPokemon('Carracosta', 7064000*1150, 53),
        new GymPokemon('Jellicent', 7464000*1150, 55),
    ],
    BadgeEnums.Wave,
    27000,
...
GymList['Elite Shauntal'] = new Gym(
    ...
    'Elite Shauntal',
    [
        new GymPokemon('Cofagrigus', 10957000*1750, 60),
        new GymPokemon('Drifblim', 10957000*1750, 60),
        new GymPokemon('Golurk', 10957000*1750, 60),
        new GymPokemon('Banette', 10957000*1750, 60),
        new GymPokemon('Chandelure', 11960250*1750, 62),
    ],
...
GymList['Elite Marshal'] = new Gym(
    ...
    'Elite Marshal',
    [
        new GymPokemon('Throh', 10957000*1750, 60),
        new GymPokemon('Sawk', 10957000*1750, 60),
        new GymPokemon('Mienshao', 10957000*1750, 60),
        new GymPokemon('Lucario', 10957000*1750, 60),
        new GymPokemon('Conkeldurr', 11960250*1750, 62),
    ],
...
GymList['Elite Grimsley'] = new Gym(
    ...
    'Elite Grimsley',
    [
        new GymPokemon('Liepard', 10945330*1750, 60),
        new GymPokemon('Scrafty', 10948300*1750, 60),
        new GymPokemon('Krookodile', 10952000*1750, 60),
        new GymPokemon('Absol', 10957000*1750, 60),
        new GymPokemon('Bisharp', 11960250*1750, 62),
    ],
...
GymList['Elite Caitlin'] = new Gym(
    ...
    'Elite Caitlin',
    [
        new GymPokemon('Musharna', 10957000*1750, 60),
        new GymPokemon('Sigilyph', 10957000*1750, 60),
        new GymPokemon('Reuniclus', 10957000*1750, 60),
        new GymPokemon('Gothitelle', 10957000*1750, 60),
        new GymPokemon('Metagross', 11960250*1750, 62),
    ],
...
GymList['Champion Iris'] = new Gym(
    ...
    'Champion Iris',
    [
        new GymPokemon('Hydreigon', 12458300*2000, 61),
        new GymPokemon('Druddigon', 12462000*2000, 61),
        new GymPokemon('Archeops', 12464000*2000, 61),
        new GymPokemon('Aggron', 12460250*2000, 61),
        new GymPokemon('Lapras', 12470000*2000, 61),
        new GymPokemon('Haxorus', 14570000*2000, 63),
    ],
...
GymList['Santalune City'] = new Gym(
    ...
    'Santalune City',
    [
        new GymPokemon('Surskit', 13737400*1800, 10),
        new GymPokemon('Vivillon (Meadow)', 17395730*1800, 12),
    ],
    BadgeEnums.Bug,
    800,
...
GymList['Cyllage City'] = new Gym(
    ...
    'Cyllage City',
    [
        new GymPokemon('Amaura', 16937530*1900, 25),
        new GymPokemon('Tyrunt', 19837400*1900, 25),
    ],
    BadgeEnums.Cliff,
    1700,
...
GymList['Shalour City'] = new Gym(
    ...
    'Shalour City',
    [
        new GymPokemon('Mienfoo', 21558300*2050, 29),
        new GymPokemon('Machoke', 22062000*2050, 28),
        new GymPokemon('Hawlucha', 22362000*2050, 32),
    ],
    BadgeEnums.Rumble,
    3800,
...
GymList['Coumarine City'] = new Gym(
    ...
    'Coumarine City',
    [
        new GymPokemon('Jumpluff', 25508300*2300, 30),
        new GymPokemon('Weepinbell', 27562000*2300, 31),
        new GymPokemon('Gogoat', 29502000*2300, 34),
    ],
    BadgeEnums.Plant,
    5500,
...
GymList['Lumiose City'] = new Gym(
    ...
    'Lumiose City',
    [
        new GymPokemon('Emolga', 30058300*2500, 35),
        new GymPokemon('Magneton', 31062000*2500, 35),
        new GymPokemon('Heliolisk', 32062000*2500, 37),
    ],
    BadgeEnums.Voltage,
    9000,
...
GymList['Laverre City'] = new Gym(
    ...
    'Laverre City',
    [
        new GymPokemon('Mawile', 33058300*2650, 38),
        new GymPokemon('Mr. Mime', 36462000*2650, 38),
        new GymPokemon('Sylveon', 38062000*2650, 42),
    ],
    BadgeEnums.Fairy,
    16000,
...
GymList['Anistar City'] = new Gym(
    ...
    'Anistar City',
    [
        new GymPokemon('Sigilyph', 40058300*2900, 44),
        new GymPokemon('Slowking', 42062000*2900, 45),
        new GymPokemon('Meowstic', 44462000*2900, 48),
    ],
    BadgeEnums.Psychic,
    30000,
...
GymList['Snowbelle City'] = new Gym(
    ...
    'Snowbelle City',
    [
        new GymPokemon('Abomasnow', 46558300*3500, 56),
        new GymPokemon('Cryogonal', 47654830*3500, 55),
        new GymPokemon('Avalugg', 50062000*3500, 59),
    ],
    BadgeEnums.Iceberg,
    52000,
...
GymList['Elite Malva'] = new Gym(
    ...
    'Elite Malva',
    [
        new GymPokemon('Pyroar', 46492423*4000, 63),
        new GymPokemon('Torkoal', 46791055*4000, 63),
        new GymPokemon('Chandelure', 46794200*4000, 63),
        new GymPokemon('Talonflame', 47223450*4000, 65),
    ],
...
GymList['Elite Siebold'] = new Gym(
    ...
    'Elite Siebold',
    [
        new GymPokemon('Clawitzer', 46492423*4000, 63),
        new GymPokemon('Gyarados', 47094530*4000, 63),
        new GymPokemon('Starmie', 47094530*4000, 63),
        new GymPokemon('Barbaracle', 47223450*4000, 65),
    ],
...
GymList['Elite Wikstrom'] = new Gym(
    ...
    'Elite Wikstrom',
    [
        new GymPokemon('Klefki', 46492423*4000, 63),
        new GymPokemon('Probopass', 47094530*4000, 63),
        new GymPokemon('Scizor', 47094530*4000, 63),
        new GymPokemon('Aegislash (Shield)', 47223450*4000, 65),
    ],
...
GymList['Elite Drasna'] = new Gym(
    ...
    'Elite Drasna',
    [
        new GymPokemon('Dragalge', 46492423*4000, 63),
        new GymPokemon('Druddigon', 47094530*4000, 63),
        new GymPokemon('Altaria', 47094530*4000, 63),
        new GymPokemon('Noivern', 47223450*4000, 65),
    ],
...
GymList['Champion Diantha'] = new Gym(
    ...
    'Champion Diantha',
    [
        new GymPokemon('Hawlucha', 40365050*4450, 64),
        new GymPokemon('Tyrantrum', 41691225*4450, 65),
        new GymPokemon('Aurorus', 41691225*4450, 65),
        new GymPokemon('Gourgeist (Average)', 41767141*4450, 65),
        new GymPokemon('Goodra', 42027136*4450, 66),
        new GymPokemon('Mega Gardevoir', 42371780*4450, 68),
    ],
...
GymList['Iki Town'] = new Gym(
    ...
    'Iki Town',
    [
        new GymPokemon('Machop', 62058739*5400, 15),
        new GymPokemon('Makuhita', 62058739*5400, 15),
        new GymPokemon('Crabrawler', 63069612*5400, 16),
    ],
...
GymList['Konikoni City'] = new Gym(
    ...
    'Konikoni City',
    [
        new GymPokemon('Anorith', 81530244*6400, 27),
        new GymPokemon('Lileep', 81530244*6400, 27),
        new GymPokemon('Lycanroc (Midnight)', 83170680*6400, 28),
    ],
...
GymList['Malie City'] = new Gym(
    ...
    'Malie City',
    [
        new GymPokemon('Sableye', 101710296*7300, 43),
        new GymPokemon('Krokorok', 101710296*7300, 43),
        new GymPokemon('Alolan Persian', 103271750*7300, 44),
    ],
...
GymList['Exeggutor Island'] = new Gym(
    ...
    'Exeggutor Island',
    [
        new GymPokemon('Alolan Dugtrio', 85759429*7850, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Gastrodon (East)', 85759429*7850, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Flygon', 85759429*7850, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Mudsdale', 86977838*7850, 48, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Golurk', 91233435*7850, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
        new GymPokemon('Gastrodon (East)', 91233435*7850, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
        new GymPokemon('Flygon', 91233435*7850, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
        new GymPokemon('Mudsdale', 92529615*7850, 54, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
    ],
...
GymList['Elite Molayne'] = new Gym(
    ...
    'Elite Molayne',
    [
        new GymPokemon('Klefki', 78883047*8850, 56),
        new GymPokemon('Bisharp', 84369882*8850, 56),
        new GymPokemon('Magnezone', 82982134*8850, 56),
        new GymPokemon('Metagross', 84733765*8850, 56),
        new GymPokemon('Alolan Dugtrio', 95774052*8850, 57),
    ],
...
GymList['Elite Olivia'] = new Gym(
    ...
    'Elite Olivia',
    [
        new GymPokemon('Armaldo', 81025320*8850, 56),
        new GymPokemon('Cradily', 74381821*8850, 56),
        new GymPokemon('Gigalith', 140708180*8850, 56),
        new GymPokemon('Probopass', 85174188*8850, 56),
        new GymPokemon('Lycanroc (Midnight)', 150439372*8850, 57),
    ],
...
GymList['Elite Acerola'] = new Gym(
    ...
    'Elite Acerola',
    [
        new GymPokemon('Banette', 94589428*8850, 56),
        new GymPokemon('Drifblim', 87179189*8850, 56),
        new GymPokemon('Dhelmise', 91179189*8850, 56),
        new GymPokemon('Froslass', 91691988*8850, 56),
        new GymPokemon('Palossand', 103277813*8850, 57),
    ],
...
GymList['Elite Kahili'] = new Gym(
    ...
    'Elite Kahili',
    [
        new GymPokemon('Braviary', 86420587*8850, 56),
        new GymPokemon('Hawlucha', 109446185*8850, 56),
        new GymPokemon('Oricorio (Baile)', 103127826*8850, 56),
        new GymPokemon('Mandibuzz', 89123587*8850, 56),
        new GymPokemon('Toucannon', 91392090*8850, 57),
    ],
...
GymList['Champion Hau'] = new Gym(
    ...
    'Champion Hau',
    [
        new GymPokemon('Alolan Raichu', 91545555*9500, 59),
        new GymPokemon('Tauros', 89636471*9500, 58),
        new GymPokemon('Noivern', 89636471*9500, 58),
        new GymPokemon('Crabominable', 91545555*9500, 59),
        new GymPokemon('Flareon', 89636471*9500, 58, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Grass)),
        new GymPokemon('Primarina', 96725389*9500, 60, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Grass)),
        new GymPokemon('Vaporeon', 89636471*9500, 58, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Fire)),
        new GymPokemon('Decidueye', 96725389*9500, 60, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Fire)),
        new GymPokemon('Leafeon', 89636471*9500, 58, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Water)),
        new GymPokemon('Incineroar', 96725389*9500, 60, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Water)),
    ],
...
GymList['Friend League'] = new Gym(
    'Karson', // red cap
    'Friend League',
    [new GymPokemon('Magikarp', 472500*5, 20)],
...
GymList['Quick League'] = new Gym(
    'Koichiro', // blue cap
    'Quick League',
    [new GymPokemon('Magikarp Skelly', 945000*5, 20)],
...
GymList['Heavy League'] = new Gym(
    'Kareign', // green cap
    'Heavy League',
    [new GymPokemon('Magikarp Orange Two-Tone', 2362500*5, 20)],
...
GymList['Great League'] = new Gym(
    'Karbuck', // blue cap
    'Great League',
    [new GymPokemon('Magikarp', 3780000*5, 20)],
...
GymList['Fast League'] = new Gym(
    'Kareign 2', // green cap
    'Fast League',
    [new GymPokemon('Magikarp Pink Dapples', 7087500*5, 20)],
...
GymList['Luxury League'] = new Gym(
    'Jump Champ', // red cap
    'Luxury League',
    [new GymPokemon('Magikarp Pink Orca', 9450000*5, 20)],
...
GymList['Heal League'] = new Gym(
    'Karami', // blue cap
    'Heal League',
    [new GymPokemon('Magikarp Purple Bubbles', 14175000*5, 20)],
...
GymList['Ultra League'] = new Gym(
    ...
    'Ultra League',
    [new GymPokemon('Magikarp Brown Tiger', 18900000*5, 20)],
...
GymList['E4 League'] = new Gym(
    ...
    'E4 League',
    [new GymPokemon('Magikarp Orange Forehead', 28350000*5, 20)],
...
GymList['Master League'] = new Gym(
    'Magikarp',
    'Master League',
    [new GymPokemon('Magikarp', 37800000*5, 20)],
...
GymList.Turffield = new Gym(
    ...
    'Turffield',
    [
        new GymPokemon('Gossifleur', 110892836*9100, 19),
        new GymPokemon('Eldegoss', 123214264*9100, 20),
    ],
...
GymList.Hulbury = new Gym(
    ...
    'Hulbury',
    [
        new GymPokemon('Goldeen', 119044213*9999, 22),
        new GymPokemon('Arrokuda', 119044213*9999, 23),
        new GymPokemon('Gigantamax Drednaw', 122651613*9999, 24),
    ],
...
GymList.Motostoke = new Gym(
    ...
    'Motostoke',
    [
        new GymPokemon('Ninetales', 125012841*10750, 25),
        new GymPokemon('Arcanine', 125012841*10750, 25),
        new GymPokemon('Gigantamax Centiskorch', 132826144*10750, 27),
    ],
...
GymList['Stow-on-Side1'] = new Gym(
    ...
    'Stow-on-Side1',
    [
        new GymPokemon('Hitmontop', 131352402*12000, 34),
        new GymPokemon('Pangoro', 131352402*12000, 34),
        new GymPokemon('Sirfetch\'d', 131352402*12000, 35),
        new GymPokemon('Gigantamax Machamp', 142075062*12000, 36),
    ],
...
GymList['Stow-on-Side2'] = new Gym(
    ...
    'Stow-on-Side2',
    [
        new GymPokemon('Galarian Yamask', 131352402*12000, 34),
        new GymPokemon('Mimikyu', 131352402*12000, 34),
        new GymPokemon('Cursola', 131352402*12000, 35),
        new GymPokemon('Gigantamax Gengar', 142075062*12000, 36),
    ],
...
GymList.Ballonlea = new Gym(
    ...
    'Ballonlea',
    [
        new GymPokemon('Galarian Weezing', 135999999*13100, 36),
        new GymPokemon('Mawile', 135999999*13100, 36),
        new GymPokemon('Togekiss', 135999999*13100, 37),
        new GymPokemon('Gigantamax Alcremie', 147097917*13100, 38),
    ],
...
GymList.Circhester1 = new Gym(
    ...
    'Circhester1',
    [
        new GymPokemon('Barbaracle', 140246069*13100, 40),
        new GymPokemon('Shuckle', 140246069*13100, 40),
        new GymPokemon('Stonjourner', 140246069*13100, 41),
        new GymPokemon('Gigantamax Coalossal', 151694727*13100, 42),
    ],
...
GymList.Circhester2 = new Gym(
    ...
    'Circhester2',
    [
        new GymPokemon('Frosmoth', 140246069*13100, 40),
        new GymPokemon('Galarian Darmanitan', 140246069*13100, 40),
        new GymPokemon('Eiscue (Ice Face)', 140246069*13100, 41, new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Hail, WeatherType.Blizzard, WeatherType.Sandstorm, WeatherType.Fog, WeatherType.Windy])),
        new GymPokemon('Eiscue (Noice Face)', 140246069*13100, 41, new WeatherRequirement([WeatherType.Harsh_Sunlight])),
        new GymPokemon('Gigantamax Lapras', 151694727*13100, 42),
    ],
...
GymList.Spikemuth = new Gym(
    ...
    'Spikemuth',
    [
        new GymPokemon('Scrafty', 145552675*14500, 44),
        new GymPokemon('Malamar', 145552675*14500, 45),
        new GymPokemon('Skuntank', 145552675*14500, 45),
        new GymPokemon('Obstagoon', 157434528*14500, 46),
    ],
...
GymList.Hammerlocke = new Gym(
    ...
    'Hammerlocke',
    [
        new GymPokemon('Gigalith', 151276613*16000, 46),
        new GymPokemon('Flygon', 151276613*16000, 47),
        new GymPokemon('Sandaconda', 151276613*16000, 46),
        new GymPokemon('Gigantamax Duraludon', 163625773*16000, 48),
    ],
...
GymList['Elite Trainer Marnie'] = new Gym(
    ...
    [
        new GymPokemon('Liepard', 160047044*17800, 47),
        new GymPokemon('Toxicroak', 160047044*17800, 47),
        new GymPokemon('Scrafty', 160047044*17800, 47),
        new GymPokemon('Morpeko', 165478757*17800, 48),
        new GymPokemon('Gigantamax Grimmsnarl', 171568449*17800, 49),
    ],
...
GymList['Elite Gym Leader Bede'] = new Gym(
    ...
    [
        new GymPokemon('Mawile', 160047044*17800, 51),
        new GymPokemon('Sylveon', 160047044*17800, 51),
        new GymPokemon('Gardevoir', 160047044*17800, 51),
        new GymPokemon('Galarian Rapidash', 165478757*17800, 52),
        new GymPokemon('Gigantamax Hatterene', 171568449*17800, 53),
    ],
...
GymList['Elite Trainer Hop'] = new Gym(
    ...
    'Elite Trainer Hop',
    [
        new GymPokemon('Dubwool', 173506298*17800, 59),
        new GymPokemon('Pincurchin', 168817428*17800, 58),
        new GymPokemon('Snorlax', 168817428*17800, 58),
        new GymPokemon('Corviknight', 179511126*17800, 60),
        new GymPokemon('Gigantamax Inteleon', 189335021*17800, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Gigantamax Rillaboom', 189335021*17800, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Gigantamax Cinderace', 189335021*17800, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
    ],
...
GymList['Champion Leon'] = new Gym(
    ...
    'Champion Leon',
    [
        new GymPokemon('Aegislash (Shield)', 177587812*24000, 62),
        new GymPokemon('Dragapult', 177587812*24000, 62),
        new GymPokemon('Haxorus', 177587812*24000, 63),
        new GymPokemon('Seismitoad', 181534208*24000, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Cinderace', 187453801*24000, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Mr. Rime', 181534208*24000, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Inteleon', 187453801*24000, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Rhyperior', 181534208*24000, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
        new GymPokemon('Rillaboom', 187453801*24000, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
        new GymPokemon('Gigantamax Charizard', 197319950*24000, 65),
    ],
...
GymList['Elite Gym Leader Klara'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Slowking', 281126897*27500, 68),
        new GymPokemon('Galarian Weezing', 281126897*27500, 68),
        new GymPokemon('Drapion', 281126897*27500, 68),
        new GymPokemon('Scolipede', 287045163*27500, 69),
        new GymPokemon('Galarian Slowbro', 295923049*27500, 70),
    ],
...
GymList['Elite Gym Leader Avery'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Slowbro', 281126897*27500, 68),
        new GymPokemon('Swoobat', 281126897*27500, 68),
        new GymPokemon('Galarian Rapidash', 281126897*27500, 68),
        new GymPokemon('Alakazam', 287045163*27500, 69),
        new GymPokemon('Galarian Slowking', 295923049*27500, 70),
    ],
...
GymList['Elite Dojo Matron Honey'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Darmanitan', 238066328*27500, 73),
        new GymPokemon('Gallade', 238066328*27500, 74),
        new GymPokemon('Salazzle', 243078251*27500, 73),
        new GymPokemon('Togekiss', 243078251*27500, 75),
        new GymPokemon('Gigantamax Venusaur', 250596135*27500, 75),
        new GymPokemon('Gigantamax Blastoise', 250596135*27500, 75),
    ],
...
GymList['Elite Dojo Master Mustard'] = new Gym(
    ...
    [
        new GymPokemon('Mienshao', 243689942*27500, 73),
        new GymPokemon('Luxray', 243689942*27500, 73),
        new GymPokemon('Lycanroc (Midday)', 248820300*27500, 75),
        new GymPokemon('Kommo-o', 248820300*27500, 75),
        new GymPokemon('Gigantamax Urshifu (Single Strike)', 256515729*27500, 75),
        new GymPokemon('Gigantamax Urshifu (Rapid Strike)', 256515729*27500, 75),
    ],
...
GymList['Elite Trainer Peony'] = new Gym(
    ...
    'Elite Trainer Peony',
    [
        new GymPokemon('Perrserker', 305387462*27500, 74),
        new GymPokemon('Bronzong', 299090814*27500, 73),
        new GymPokemon('Scizor', 299090814*27500, 73),
        new GymPokemon('Aggron', 305387462*27500, 74),
        new GymPokemon('Copperajah', 314832436*27500, 74),
    ],
